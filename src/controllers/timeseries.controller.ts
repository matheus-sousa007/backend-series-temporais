...
const add_dummy_variables = (time_series_data: any) => {
...
export const getTimeSeriesById = async (req: express.Request, res: express.Response) => {
    ...
    try {
        ...
        let { rows } = await db.query(`SELECT * FROM ${'a' + codename!.toLowerCase() + '_'}`)
